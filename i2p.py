...
class I2PRouterMenu(QMainWindow):
    def __init__(self):
        ...
        self.logo_pixmap = QPixmap("i2plogo.png")
    ...
    def start_router(self):
        self.statusBar().showMessage("Starting I2P Router...")
    ...
    def stop_router(self):
        self.statusBar().showMessage("Stopping I2P Router...")
    ...
    def graceful_stop(self):
        self.statusBar().showMessage("Gracefully stopping I2P Router...")
    ...
    def restart_router(self):
        self.statusBar().showMessage("Restarting I2P Router...")
    ...
    def check_status(self):
        self.statusBar().showMessage("Checking I2P Router status...")
        output, error, code = self.run_command("i2prouter status")
        if code == 0:
            self.show_output("I2P Router Status", output)
        else:
            self.show_output("Error", "Failed to check I2P Router status.", error)
        self.statusBar().showMessage("Ready")
    
    def install_i2p(self):
        self.statusBar().showMessage("Installing I2P and enabling auto-start...")
    ...
    def remove_i2p(self):
        self.statusBar().showMessage("Removing I2P and disabling auto-start...")
    ...
    def view_thread_dump(self):
        self.statusBar().showMessage("Viewing thread dump...")
